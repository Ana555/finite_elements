...
namespace Finite_Elements_method
{
    public partial class MainForm : Form
    {
        ...
        void Draw(PaintEventArgs e, bool withMoves)
        {
            ...
            Pen blackPenForCircle = new Pen(Color.Black);
  
            blackPen.Width = 2;
            redPen.Width = 5;
            blackPenForCircle.Width = 2;
            ...
            for (int i = 0; i < cd.NExternalNodes; i++)
            {
                ...
                if (withMoves)
                {
                    ...
                    e.Graphics.DrawEllipse(blackPenForCircle, x - 4, y - 4, 8, 8);
                }
                else
                {
                    if (pI.Dx != 0 || pI.Dy != 0)
                    {
                        x = CoordXtoScreenX(pI.X + pI.Dx);
                        y = CoordYtoScreenY(pI.Y + pI.Dy);
                        e.Graphics.DrawEllipse(redPen, x - 4, y - 4, 8, 8);
                    }
                }
